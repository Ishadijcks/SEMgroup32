...
>>>>>>> master
            ...
            if (curLevel.hasRope()) {
                ...
                if (dragonIsRight) {
<<<<<<< HEAD THis changes the location only + topMargin so the board location isnot absolute
...
>>>>>>> master
                ...
                if (ropeDurationCounter < 40 || !(shootRope)) {
                    ...
                    drawDragon(player, newX);
                }

<<<<<<< HEAD The postion is changed again with the + topmargin 
